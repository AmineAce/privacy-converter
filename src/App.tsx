    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex">
        <aside className="hidden xl:flex w-[300px] flex-col gap-6 sticky top-32 h-fit pl-6">
          <AdSpace type="vertical" imageSrc="/ads/nordpass.jpg" linkUrl="https://go.nordpass.io/aff_c?offer_id=488&aff_id=138496&url_id=9356" />
        </aside>
        ...
        <aside className="hidden lg:flex w-[300px] flex-col gap-6 sticky top-32 h-fit pr-6">
          <AdSpace type="vertical" imageSrc="/ads/nordvpn.jpg" linkUrl="https://go.nordvpn.net/aff_c?offer_id=15&aff_id=138496&url_id=902" />
